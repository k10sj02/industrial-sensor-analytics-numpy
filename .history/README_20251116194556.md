...
Generating one billion iterations in pure Python would take hours—or even days. A billion `float64` numbers require roughly 8 GB of RAM (plus overhead), which will crash most laptops. In real-world projects, you’d often work with 1 million rows instead.
